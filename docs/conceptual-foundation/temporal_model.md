...
PMBRS uses a globally aligned fixed 60-second window grid as the canonical temporal reference system for all modalities.

All sensor streams, sparse events, semantic artifacts, and derived representations are deterministically projected onto this shared timeline using modality-specific alignment rules.
...
- reliable comparison across modalities and time.
